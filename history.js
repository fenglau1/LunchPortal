...
const DetailsModal = {
    open: (id) => {
        ...
        document.getElementById('d-content').innerHTML = `<div class="detail-row"><span class="detail-label">Payer</span><span class="detail-val">${item.payer || item.user}</span></div><div class="detail-row"><span class="detail-label">Order For</span><span class="detail-val">${item.user}</span></div><div class="detail-row"><span class="detail-label">Item</span><span class="detail-val">${item.item}</span></div><div class="detail-row"><span class="detail-label">Notes</span><span class="detail-val">${item.remarks || '-'}</span></div><div class="detail-row"><span class="detail-label">Price</span><span class="detail-val">${Utils.formatCurrency(item.price)}</span></div><div class="detail-row"><span class="detail-label">Payment Ref</span><span class="detail-val">${item.paymentRef || 'Not set'}</span></div><div class="detail-row"><span class="detail-label">Date</span><span class="detail-val">${item.date}</span></div>`;
